...
fun BookPlayScreen(bookId: BookId) {
  ...
  BookPlayView(
    ...
    claritySheetVisible = viewModel.claritySheetVisible.value,
    onClarityOpen = viewModel::showClaritySheet,
    onClarityDismiss = viewModel::hideClaritySheet,
    onClarityToggle = viewModel::onClarityToggle,
    onClarityRumbleChange = viewModel::onClarityRumbleChange,
    onClarityPresenceChange = viewModel::onClarityPresenceChange,
    onClarityCompressionChange = viewModel::onClarityCompressionChange,
